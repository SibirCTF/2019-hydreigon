...
module Analitycs
  class Application < Hanami::Application
    configure do
      ...
      #
      # sessions :cookie, secret: ENV['ANALITYCS_SESSIONS_SECRET']
      ...
      #
      layout :application # It will load Analitycs::Views::ApplicationLayout
      ...
      # Configure the code that will yield each time Analitycs::Action is included
      ...
      # Configure the code that will yield each time Analitycs::View is included
      # This is useful for sharing common functionality
      #
      # See: http://www.rubydoc.info/gems/hanami-view#Configuration
      view.prepare do
        include Hanami::Helpers
        include Analitycs::Assets::Helpers
      end
    end
